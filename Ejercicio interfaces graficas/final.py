...
# Objetivo 1:
# Escribí una función que cree una ventana que tenga por título “Ingreso de Datos”, y que su tamaño sea de 500 x 300 pixels.

import tkinter as tk
from tkinter import messagebox

def crear_ventana_objetivo_1():
    ventana = tk.Tk()
